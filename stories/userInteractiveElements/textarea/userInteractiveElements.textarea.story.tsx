...
import { Form, FormGroup, TextArea, ErrorTip, SubmitButton } from "../../../src";
...
storiesOf("User interactive elements", module)
    .add("<TextArea />", () => {
        ...
        return (
            <React.Fragment>
                <ReactMarkdown className="markdown" source={require("./userInteractiveElements.textarea.md").default} />
                <Form
                    validator={validator}
                ...
                >
                    <div className="form-group-wrap">
                        ...
                        <FormGroup attribute="name" className="form-group" validateOn="blur">
                            ...
                            <TextArea maxLength={4} className="form-control" />
                    ...
                    <div className="form-group-wrap">
                        ...
                        <FormGroup attribute="surname" className="form-group" validateOn="blur">
                            ...
                            <TextArea id="user_model-surname" className="form-control" />
                            <ErrorTip className="form-error" />
                        </FormGroup>
                    </div>
